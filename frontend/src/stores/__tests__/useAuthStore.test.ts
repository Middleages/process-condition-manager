...
describe('useAuthStore', () => {
  ...
  describe('login', () => {
    it('sets user and accessToken on successful login', async () => {
      const mockUser = { id: 1, username: 'admin', display_name: 'Admin User', role: 'admin' }
    ...
    it('sends form-encoded data (not JSON) to login endpoint', async () => {
      const mockUser = { id: 1, username: 'admin', display_name: 'Admin', role: 'admin' }
      mockPost.mockResolvedValueOnce({
  ...
  describe('fetchCurrentUser', () => {
    it('updates user from /auth/me endpoint', async () => {
      const mockUser = { id: 2, username: 'editor', display_name: 'Editor User', role: 'editor' }
