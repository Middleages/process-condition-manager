...
import { useProjectDetail, useBulkSave } from '@/hooks/useProjects'
...
export default function ConditionEditorPage() {
  ...
  }, [project, currentUserId, dirtyCells, bulkSave, clearAllDirty, setIsSaving])
  ...
  const handleErrorClick = useCallback(
    (error: ValidationError) => {
      // Find the category that contains this column
