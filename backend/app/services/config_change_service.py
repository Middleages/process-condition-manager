...
def _build_vote_response(vote: ConfigChangeVote) -> ConfigChangeVoteResponse:
    ...
    return ConfigChangeVoteResponse(
        ...
        voter_name=vote.voter.userid if vote.voter else None,
        reason=vote.reason,
...
def _build_response(
    ...
    *,
    ...
    base = dict(
        ...
        requester_name=req.requester.userid if req.requester else None,
        implemented_by=req.implemented_by,
        implementer_name=req.implementer.userid if req.implementer else None,
        rejected_by=req.rejected_by,
        rejector_name=req.rejector.userid if req.rejector else None,
