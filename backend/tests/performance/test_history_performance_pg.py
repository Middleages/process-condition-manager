...
def _timeline_page_statement(
    ...
    return (
        ...
        .order_by(ChangeEvent.project_id, ChangeEvent.id.desc())
        .limit(50)
    )
...
def _timeline_layer_statement(
    ...
    return (
        ...
        .order_by(ChangeEvent.project_id, ChangeEvent.layer_key, ChangeEvent.id.desc())
        .limit(50)
    )
...
def _timeline_actor_statement(
    ...
    return (
        ...
        .order_by(ChangeEvent.project_id, ChangeEvent.actor, ChangeEvent.id.desc())
        .limit(50)
    )
...
def _timeline_origin_statement(
    ...
    return (
        ...
        .order_by(ChangeEvent.project_id, ChangeEvent.origin, ChangeEvent.id.desc())
        .limit(50)
    )
