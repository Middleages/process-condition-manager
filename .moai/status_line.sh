...
if [ -f "/home/appuser/go/bin/moai" ]; then
	exec "/home/appuser/go/bin/moai" statusline < "$temp_file"
fi

# Try user local bin directory
if [ -f "/home/appuser/.local/bin/moai" ]; then
	exec "/home/appuser/.local/bin/moai" statusline < "$temp_file"
fi
